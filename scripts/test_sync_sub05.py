#!/usr/bin/env python3
"""
Test synchronization for sub-05 run-1 with corrected offset direction.
"""
...
# ==============================================================================
# Cross-correlation with realistic search window (±30s)
# ==============================================================================
...
# CORRECTED: Add offset to external time (not subtract)
...
# Create plot with full view and segments
...
print()
print(f"Plot saved: {OUTPUT_DIR}/sync_test_{SUBJECT}_run{RUN:02d}.png")
print("=" * 70)
