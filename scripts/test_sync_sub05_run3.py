#!/usr/bin/env python3
"""
Test synchronization for sub-05 run-3 to check if issue is run-specific.
"""
...
# Paths for sub-05 run-03
SUBJECT = "sub-05"
RUN = 3

MEG_FILE = Path("/Users/em18033/Library/CloudStorage/OneDrive-SharedLibraries-MacquarieUniversity/Natural_Conversations_study - Documents/analysis/natural-conversations-bids/derivatives/mne-bids-pipeline-20240628/sub-05/meg/sub-05_task-conversation_run-03_proc-clean_raw.fif")
AUDIO_FILE = Path("/Users/em18033/Library/CloudStorage/OneDrive-AUTUniversity/Projects/Conversational_AI/Archive/data/audios/G05/console_mic_B3.wav")
